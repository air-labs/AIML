...
\draw[red,thick] plot file {Plots/A.dat};
\draw[blue,thick] plot file {Plots/B.dat};
...
\only<2>
{
\fill[fill=teal,opacity=0.2] plot file {Plots/A_cap1_B.dat};
\node at (2.5,0.2) {$A\fcap B,\ \min$};
}

\only<3>
{
\fill[fill=teal,opacity=0.2] plot file {Plots/A_cup1_B.dat};
\node at (2.5,0.2) {$A\fcup B,\ \max$};
}

\only<4>
{
\fill[fill=teal,opacity=0.2] plot file {Plots/A_cap2_B.dat};
\node at (2.5,0.2) {$A\fcap B,\ ab$};
}

\only<5>
{
\fill[fill=teal,opacity=0.2] plot file {Plots/A_cup2_B.dat};
\node at (2.5,0.2) {$\begin{array}{c}A\fcup B\\a+b-ab\end{array}$};
}


%\fill[fill=orange] plot file {Plots/A_cap1_B.dat};
%\fill[fill=orange] plot file {Plots/A_cap1_B.dat};
