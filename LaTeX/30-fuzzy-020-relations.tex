...
$$
$$
\rho\sqsubset\mathbb{C}\times\mathbb{M}
$$
}
\uncover<3->{
$$
...
$$
$$
\mu_M(m)=\max_{c\in\mathbb{C}}\left[\mu_C(c) \mu_\rho(c,m)\right]
$$
}
...
\column{0.6\textwidth}
$$
\sigma\sqsubset\mathbb{M}\times\mathbb{H}
$$
$$
...
$$
\tau=\rho\circ\sigma
,\ \tau\sqsubset\mathbb{M}\times\mathbb{H}
$$
$$
\begin{array}{ >\vc m{0.7cm}| >\vc m{0.7cm} >\vc m{0.7cm} >\vc m{0.7cm}}
$\tau$   & \aca & \hel & \nec \\
